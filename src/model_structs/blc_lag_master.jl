...
"""
Master wrapper for the BlCLag solver.

`BlCLagMaster` stores the first-level relaxation, binary linking variables,
subproblem names, and second-level objective expressions used to generate
BlC-style coefficients from the problem structure.
"""
