...
Print a collection of `RunStats` objects into a CSV file.
"""
...
Convert a collection of `RunStats` objects into a `DataFrame`.
"""
...
Collect the union of keys present in a collection of `RunStats`.
"""
