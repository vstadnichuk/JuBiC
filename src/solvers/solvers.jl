...
# Arguments
- 'inst::Instance': The problem instance.
- 'params::BLCparam': The parameters for the solver
...
"""
    solve_instance(inst::Instance, params::BlCLagparam)

Solve the passed insatnce with our BlCLagSolver employing Benders-like decomposition where the Benders-like cuts are generated by solving a Lagrangian dual. 

# Arguments
- 'inst::Instance': The problem instance.
- 'params::BlCLagparam': The parameters for the solver
